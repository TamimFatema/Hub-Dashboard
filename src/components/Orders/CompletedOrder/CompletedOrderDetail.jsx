          ...
          <div className="border-2 shadow-lg rounded-lg p-2 lg:w-3/4">
            <div className="flex justify-between px-2">
              ...
              <div className="flex gap-4">
                <button className="bg-[#5709BB] text-white flex gap-2 rounded-md px-4 py-2 h-fit items-center">
                  <Image
            ...
            <div className="flex flex-col items-end w-full">
              <div className="flex mt-2 gap-1">
                ...
                <button className="bg-gray-100 text-[#00BE85] p-1 border-2 rounded-xl shadow-2xl">
                  completed
                </button>
              </div>
